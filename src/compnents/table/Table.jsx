        ...
        <table>
            ...
            <tr>
                ...
                {item.featured?
                            ...
                            <span className={styles.address}>{item.address}</span> <br/>
                            {item.cutoff?
                ...
                <td>
                    <div className={styles.userReview}>
                        <span className={styles.ratingcir}><img src="https://cdn-icons-png.flaticon.com/128/5111/5111178.png" alt="" /> {item.rating}/10</span><br/>
